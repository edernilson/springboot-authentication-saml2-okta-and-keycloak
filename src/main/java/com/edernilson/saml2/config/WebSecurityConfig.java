...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter implements InitializingBean, DisposableBean {
    ...
    private String defaultIdpMetadata;
    ...
    public void init() {
        this.backgroundTaskTimer = new Timer("saml2", true);
    ...
    public ExtendedMetadataDelegate extendedMetadataProvider()
        ...
        String idpSSOCircleMetadataURL = defaultIdpMetadata;
    ...
    public SavedRequestAwareAuthenticationSuccessHandler successRedirectHandler() {
        ...
        successRedirectHandler.setDefaultTargetUrl("/index");
